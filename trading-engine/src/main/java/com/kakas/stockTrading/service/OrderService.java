...
public class OrderService {
    ...
    // 创建订单
    public Order createOrder(Long orderId, Long userId, long sequenceId, Direction direction, BigDecimal price, BigDecimal quantity, long createAt) {
        // 冻结资产
        switch (direction) {
            case SELL -> {
